        ...
        <div className="grid md:grid-cols-2 gap-8 mt-8">
          ...
          <FadeIn delay={0.15}>
            <div className="aspect-[4/3] rounded-2xl bg-secondary/50 border border-border/50 flex items-center justify-center overflow-hidden">
              <iframe
                src={`https://maps.google.com/maps?q=${encodeURIComponent(`${siteConfig.address.street}, ${siteConfig.address.zip} ${siteConfig.address.city}`)}&t=&z=16&ie=UTF8&iwloc=B&output=embed&hl=en`}
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
