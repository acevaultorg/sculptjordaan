        ...
        <FadeIn>
          <article className="mx-auto max-w-3xl">
            ...
            <div className="relative w-full aspect-[2/1] rounded-2xl overflow-hidden mb-10">
              <Image src="/images/studio/studio-overview.jpeg" alt="SculptClub privé studio voor personal trainers" fill className="object-cover" preload sizes="(max-width: 768px) 100vw, 800px" />
            </div>
