...
export const metadata: Metadata = {
  ...
  description:
    "Lees wat onze klanten zeggen over SculptClub. 5.0 sterren op Google met 8 reviews. Boutique personal training in Amsterdam Jordaan.",
  alternates: {
...
const reviews = [
  ...
  },
  {
    ...
    text: "Ik geef hier mijn small group Calisthenics aan 3 atleten. Geweldige locatie! Klein maar fijn. Heeft alles wat wij nodig hebben. Zelfs gratis koffie en thee!",
    rating: 5,
    date: "feb 2026",
    badge: "Local Guide",
  },
  {
    name: "Pien Buseman",
    text: "Wat een cadeau een 'boutique' sportschool met goede trainers op loopafstand. Het is klein maar zeer fijn. Alle apparaten zijn aanwezig, indien gewenst met een PT en je kan er ook zelf trainen. Aanwinst voor in de buurt!",
    rating: 5,
    date: "okt 2025",
  },
  {
  ...
  },
  {
    ...
    text: "Ik kijk uit naar de opening van SculptClub! Het lijkt me een prettige en kleinschalige plek om te trainen, zonder de drukte van een grote sportschool. De locatie is ideaal en goed toegankelijk.",
    rating: 5,
    date: "aug 2025",
  },
  {
    name: "Rick Schippers",
    text: "Wat tof dat er een nieuwe sportschool komt aan de Egelantiersgracht! Echt een aanwinst voor de buurt. Ik kijk er enorm naar uit om hier straks te kunnen sporten — lekker dichtbij huis.",
    rating: 5,
    date: "aug 2025",
  },
  {
  ...
  {
    name: "Kevin Berghuis",
    text: "Wauw wat een top locatie van deze sportschool! Ik kan niet wachten om mijn eerste workout bij jullie te starten. It's such an inspiring setting to train in!",
    rating: 5,
    date: "aug 2025",
  },
];
...
const reviewsJsonLdData = reviews.map((r) => ({
  ...
  text: r.text,
  rating: r.rating,
  date: r.date.replace(/feb 2026/i, "2026-02-01").replace(/okt 2025/i, "2025-10-01").replace(/aug 2025/i, "2025-08-01"),
}));

export default function ReviewsPageNL() {
  return (
    <PageLayout>
      <BreadcrumbJsonLd items={[{"name":"Home","url":"/"},{"name":"Reviews","url":"/nl/reviews"}]} />
