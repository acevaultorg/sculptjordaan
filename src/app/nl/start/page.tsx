...
const paths = [
  {
    ...
    description: "Vind een trainer die bij jouw doelen past. De eerste intake is 100% gratis.",
  ...
  },
  {
    ...
    description: "Huur onze volledig uitgeruste studio voor jouw cli\u00ebnten. 0% commissie. Jouw tarief, jouw planning.",
