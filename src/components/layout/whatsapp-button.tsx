...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      aria-label={label}
      className="fixed bottom-24 md:bottom-6 right-6 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg hover:bg-[#20bd5a] transition-all duration-300 hover:scale-105 animate-pulse-once"
    >
